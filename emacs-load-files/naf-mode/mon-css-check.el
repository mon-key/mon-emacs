...
;; Keywords: css, web, html, extensions

;;; ==============================
;; <Timestamp: #{2010-03-31T19:00:44-04:00Z}#{10133} - by MON>
;; :NOTE This is Niels Giesen's css-check.el which integrates the csstidy
;; program with Emacs (URL `http://sourceforge.net/projects/csstidy/')
;; Niels css-check is available from the git repo here:
;; URL: http://github.com/pft/elisp-assorted/blob/master/css-check.el
;; 
;; Following enumerate the changes and modifications included w/ this file:
;; RENAMED: 
...
;; correspondences from *CSS-CHECK* -> *css-check-file* and so nothing gets
;; replaced.  Its not clear to me what is happening or why, including whether my
